...
class App:
    def __init__(self, root):
        ...
        ListBoxCargos=tk.Listbox(root)
        ListBoxCargos["borderwidth"] = "1px"
        ft = tkFont.Font(family='Times',size=10)
        ListBoxCargos["font"] = ft
        ListBoxCargos["fg"] = main_with_experimental_gui.COR_LETRA
        ListBoxCargos["bg"] = main_with_experimental_gui.COR_BOTAO
        ListBoxCargos["justify"] = "center"
        ListBoxCargos.place(x=30,y=70,width=218,height=188)
